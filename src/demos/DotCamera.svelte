<script lang="ts">
	...
	const W = new Float32Array([
		-67, 1, 2, 44, -13, -59, 4, 30, -1, 16, -57, 9, -10, -4, -2, -41, 19, -18, -1, 8, -4, 35, 8, 0,
		-4, -4, -1, 0, 34, 31, 21, -25, 4, 13, 18, -57, -79, -22, -25, 71, -12, -11, 24, 27, -17, -8,
		-7, 6, 11, 10, 4, 0, 4, 1, 2, 7, -26, -33, -15, -3, 22, 27, 20, -34
	]);
	const b = new Float32Array([2, -5, -14, 9]);
				...
				points = glsl(
					{
						...arg,
						field: field.edge,
						imgForce: imgForce.edge.linear,
						seed: Math.random() * 124237,
						FP: `
...
varying vec3 color = vec3(c==0,c==1,c==2);`,
						FP: `
